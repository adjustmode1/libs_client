...
const EditStudent = () => {
    const [id,setId] = useState('B1809222')
    const [name,setName] = useState('Nguyễn Văn A')
    const [gender,setGender] = useState(false)
    const [address,setAddress] = useState('')
    const [gmail,setGmail] = useState('gmail1@gmail.com')
    const [phone,setPhone] = useState('0123578215')
    const [coure,setCoure] = useState('44')
            ...
            <Form>
              ...
              <Row>
                ...
                <Col md="6" className="mb-3">
                  ...
                  <input
                    value={gmail}
                    className={gmail? "form-control is-valid" : "form-control is-invalid"}
                    onChange={(e)=>{setCoure(e.target.value)}}
                    type="text"
                    id="defaultFormRegisterPasswordEx4"
                    name="city"
